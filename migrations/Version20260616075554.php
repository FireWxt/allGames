 ...
 */
final class Version20260616075554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, release_date DATETIME NOT NULL, editor_id INT DEFAULT NULL, review_id INT DEFAULT NULL, INDEX IDX_232B318C6995AC4C (editor_id), INDEX IDX_232B318C3E2E969B (review_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE whislist_item (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, user_id INT DEFAULT NULL, game_id INT DEFAULT NULL, INDEX IDX_6C965ED7A76ED395 (user_id), INDEX IDX_6C965ED7E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
